...
$viewsModels = array(
   ...
   'award1' => array(
      ...
      "filters" => array(
         ...
         "userID" => array("joins" => array("full_groups"), "condition" => "(`full_groups`.`userID` IN ((SELECT DISTINCT `userID` FROM `user_user` AS `user_user_condition` WHERE `user_user_condition`.`targetUserID` = :[PREFIX_FIELD]userID) UNION (SELECT :[PREFIX_FIELD]userID AS userID)))"),
