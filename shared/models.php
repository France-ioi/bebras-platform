...
$viewsModels = array(
   ...
   'award1' => array(
      ...
      "filters" => array(
         ...
         "schoolID" => array("joins" => array("group"), "condition" => "`group`.`schoolID` = :[PREFIX_FIELD]schoolID"),
         ...
         "ownerUserID" => array("joins" => array("group"), "condition" => "`group`.`userID` = :[PREFIX_FIELD]ownerUserID"),
...
//         "full_groups" => array("srcTable" => "team", "srcField" => "groupID", "dstField" => "ID"),
      ...
      "filters" => array(
         ...
         "relatedContestID" => array("joins" => array("contest", "group"), "condition" => "(`[PREFIX]group`.`contestID` = :relatedContestID OR `[PREFIX]contest`.`parentContestID` = :relatedContestID)"),
         ...
         "relatedGroupID" => array("joins" => array("group", "team"), "condition" => "(`[PREFIX]team`.`groupID` = :relatedGroupID OR `group`.`parentGroupID` = :relatedGroupID)"),
         "schoolID" => array("joins" => array("group"), "condition" => "`group`.`schoolID` = :schoolID"),
         "userID" => array("joins" => array("group", "userIDs"), "condition" => "`group`.`userID` = `[PREFIX]userIDs`.`userID`"),
         "ownerUserID" => array("joins" => array("group"), "condition" => "`group`.`userID` = :[PREFIX_FIELD]ownerUserID"),
