...
var scratchToBlocklyContestID = {
  "123556559616198459": "20284639530086786", // 2020.1 white
  "204034698343183586": "203470753157869958", // 2020.1 yellow
  "219201791586950565": "227677046248069693", // 2020.1 orange
  "214570819714244963": "285545119426515177" // 2020.1 green
};
...
window.groupWasChecked = function(data, curStep, groupCode, getTeams, isPublic, contestID) {
   ...
   if (data.teamID !== undefined) { // The password of the team was provided directly
      ...
      if ((data.nbMinutesElapsed > data.groupsExpirationMinutes) && (data.groupsExpirationMinutes != 0) && (!data.isPublic) && (!data.isGenerated) && (!getTeams)) {
