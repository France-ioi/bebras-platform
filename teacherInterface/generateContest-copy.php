...
require_once('../shared/contest-generator/ContestGenerator.php');
...
*/
      ...
      $params = [
         ...
         'tasks_repository_path' => __DIR__.'/bebras-tasks/'
      ];
      $generator = new ContestGenerator($params);

      $params = [
         'contestID' => $contestID,
         'contestFolder' => $contestFolder.'.v2',
      ...
      $generator->generate($tasks, $params);
